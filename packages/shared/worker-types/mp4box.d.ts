// This is a copy of types/mp4box.d.ts but replaced mp4box with global
// https://github.com/gpac/mp4box.js/issues/233

declare interface MP4MediaTrack {
    id: number;
    created: Date;
    modified: Date;
...
declare interface MP4VideoData {
    width: number;
    height: number;
}

declare interface MP4VideoTrack extends MP4MediaTrack {
    video: MP4VideoData;
}

declare interface MP4AudioData {
    sample_rate: number;
    channel_count: number;
    sample_size: number;
}

declare interface MP4AudioTrack extends MP4MediaTrack {
    audio: MP4AudioData;
}

declare type MP4Track = MP4VideoTrack | MP4AudioTrack;
...
declare class DataStream {
    ...
    // TODO add correct types; these are declareed by dts-gen
...
declare interface TrackOptions {
    id?: number;
    type?: string;
    width?: number;
    height?: number;
...
declare interface SampleOptions {
...
declare namespace BoxParser {
    ...
    /* ???
	namespace UUIDBoxes {
		declare class a2394f525a9b4f14a2446c427c648df4 {
			constructor(size: any)
		}

		declare class a5d40b30e81411ddba2f0800200c9a66 {
			constructor(size: any)

			parse(stream: any): void
		}

		declare class d08a4f1810f34a82b6c832d8aba183d3 {
			constructor(size: any)

			parse(stream: any): void
		}

		declare class d4807ef2ca3946958e5426cb9e46a79f {
			constructor(size: any)
...
declare class MultiBufferStream {
...
declare function MPEG4DescriptorParser(): any;
